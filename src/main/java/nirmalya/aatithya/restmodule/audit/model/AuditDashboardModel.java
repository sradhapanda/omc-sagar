...
public class AuditDashboardModel {
	...
	public AuditDashboardModel(Object totalImprovement, Object totalPom, Object totalNc, Object totalOpen,
			Object totalPending,Object pendingreplied,Object pendingObservation,Object pendingRequistion,
			Object totalNotObserved,Object totalOpenStatus,Object totalRepliedStatus,Object totalReOpen,
			Object totalClosed,Object monthname,Object monthData,Object auditSectionStatus,Object repliedByConcernAudit,Object replied,
			Object pendingReply,Object totalAudit,Object section,Object date,Object reqNo,Object raisedBy,Object raisedTo) {
		super();
		this.totalImprovement = (String) totalImprovement;
		this.totalPom = (String) totalPom;
		this.totalNc = (String) totalNc;
		this.totalOpen = (String) totalOpen;
		this.totalPending = (String) totalPending;
		this.pendingreplied = (String) pendingreplied;
		this.pendingObservation = (String) pendingObservation;
		this.pendingRequistion = (String) pendingRequistion;
		this.totalNotObserved = (String) totalNotObserved;
		this.totalOpenStatus = (String) totalOpenStatus;
		this.totalRepliedStatus = (String) totalRepliedStatus;
		this.totalReOpen = (String) totalReOpen;
		this.totalClosed = (String) totalClosed;
		this.monthname = (String) monthname;
		this.monthData = (String) monthData;
		this.auditSectionStatus = (String) auditSectionStatus;
		this.repliedByConcernAudit = (String) repliedByConcernAudit;
		this.replied = (String) replied;
		this.pendingReply = (String) pendingReply;
		this.totalAudit = (String) totalAudit;
		this.section=(String)section;
		this.date = (String) date;
		this.reqNo = (String) reqNo;
		this.raisedBy = (String) raisedBy;
		this.raisedTo = (String) raisedTo;
